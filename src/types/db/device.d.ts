...
export interface IDatabaseDevice {
     ...
     * @async
     * @method getDBs()
     * @description returns a list of all DBs
     * 
     ...
     * @async
     * @method createDB()
     * @description creates a new DB in the rethink host
     * @param dbName {string} the name of the DB
     * 
     * @returns returns true on creation, false otherwise
     */
    createDB(
        dbName:string
    ):Promise<boolean>;
     ...
     * @async
     * @method removeDB()
     * @description drops a DB in the rethink host
     * @param dbName {string} the name of the DB
     * 
     * @returns returns true on drop, false otherwise
     */
    dropDB(
        dbName:string
    ):Promise<boolean>;
